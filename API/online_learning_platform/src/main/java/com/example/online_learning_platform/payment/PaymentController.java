...
@RestController
@RequestMapping("/online-learning-platform/auth/payments")
public class PaymentController {
    ...
    public Boolean processPayment(@PathVariable Long courseId, @RequestBody PaymentRequest paymentrequest) {
        boolean success = paymentService.processPayment(
                paymentrequest.getCardNumber(),
                paymentrequest.getExpirationDate(),
                paymentrequest.getCvv(),courseId
        );
